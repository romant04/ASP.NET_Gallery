        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Albums_AspNetUsers_UploaderId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AlbumStoredFile", x => new { x.AlbumId, x.FilesId });
                    table.ForeignKey(
                        name: "FK_AlbumStoredFile_Albums_AlbumId",
                        column: x => x.AlbumId,
                        principalTable: "Albums",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AlbumStoredFile_Files_FilesId",
                        column: x => x.FilesId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GalleryOrders_Files_StoredFileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Position_Files_StoredFileId",
                        column: x => x.StoredFileId,
                        principalTable: "Files",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AlbumStoredFile_FilesId",
                table: "AlbumStoredFile",
                column: "FilesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GalleryOrders_StoredFileId",
                table: "GalleryOrders",
                column: "StoredFileId");

            migrationBuilder.CreateIndex(
                name: "IX_Position_StoredFileId",
                table: "Position",
                column: "StoredFileId");
        }
